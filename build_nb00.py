...
SUMMARY = (
    ...
    '---\n\n'
    '## 7. Literatura\n\n'
    '- Mantegna (1999). Hierarchical structure in financial markets. *European Physical Journal B*, 11.\n'
    '- Onnela et al. (2003). Dynamics of market correlations. *Physical Review E*, 68.\n'
    '- Billio et al. (2012). Econometric measures of connectedness and systemic risk. *Journal of Financial Economics*, 104(3).\n'
    '- Xu et al. (2017). Topological change of the world stock market. *Studies in Economics and Finance*, 34(3).\n'
    '- Newman (2010). *Networks: An Introduction*. Oxford University Press.\n'
    '- Kritzman et al. (2011). Principal components as a measure of systemic risk. *Journal of Portfolio Management*, 37(4).\n'
    '- Bollerslev (1986). GARCH. *Journal of Econometrics*, 31(3).\n'
    '- Diebold & Mariano (1995). Comparing predictive accuracy. *JBES*, 13(3).\n'
    '- Bekaert & Harvey (2002). Research in emerging markets finance. *Emerging Markets Review*, 3(4).\n'
)
...
cells = [
    ...
    md('## 2. Metodoloski pipeline: od prinosa do mreze\n\n'
       ...
       'Zasto ne standardni indeks? Na malom trzistu dionica $i$ cini dio indeksa '
       '- self-inclusion bias. EW-LOO to eliminira.\n\n'
